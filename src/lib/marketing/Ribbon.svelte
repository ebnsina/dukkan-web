...
<div class="relative z-60 bg-mk-dark text-[13px] text-mk-cream">
	<!--
		The chip belongs to the sentence, so it travels with it. Left loose in the
		row it took a line of its own on a phone and the ribbon grew to three
		uneven bands. Row gap matches the vertical padding, so a wrapped ribbon
		keeps one rhythm.
	-->
