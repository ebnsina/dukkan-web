...
<style>
	.app {
		...
		/* The shell is grey and the content floats on it as one white sheet.
		   Cards inside the sheet tint rather than stack another white on white. */
		--d-shell: #efefec;
		--d-sheet: #ffffff;
		--d-card: #f7f7f5;
		--d-line: #ececea;
	...
	.n-badge {
		...
		padding: 1px 6px;
		border-radius: 20px;
		background: rgba(120, 122, 130, 0.14);
		font-size: 11.5px;
		text-align: center;
	...
	.chip {
		...
		font-size: 11.5px;
		font-weight: 600;
		background: rgba(120, 122, 130, 0.13);
		color: var(--d-muted);
		white-space: nowrap;
	}
