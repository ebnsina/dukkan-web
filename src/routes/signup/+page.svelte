				...
				<section class="mt-9">
					...
					<div class="mt-8">
						<button
							...
							disabled={!nameReady}
							onclick={() => (step = 1)}
							class="group flex cursor-pointer items-center gap-2 rounded-mk-control border border-mk-brand bg-mk-brand px-6 py-[15px] font-mk-mono text-[12px] font-medium tracking-[0.12em] text-mk-on-brand uppercase transition-colors duration-200 hover:border-mk-brand-deep hover:bg-mk-brand-deep disabled:cursor-not-allowed disabled:border-mk-shell-deep disabled:bg-mk-shell-deep disabled:text-mk-faint"
						>
							Next
				...
				<section class="mt-9">
					...
					<div class="mt-8 flex flex-wrap items-center gap-4">
						...
						<button
							type="button"
							onclick={() => (step = 3)}
							class="group flex cursor-pointer items-center gap-2 rounded-mk-control border border-mk-brand bg-mk-brand px-6 py-[15px] font-mk-mono text-[12px] font-medium tracking-[0.12em] text-mk-on-brand uppercase transition-colors duration-200 hover:border-mk-brand-deep hover:bg-mk-brand-deep"
						>
							Next
							<span class="transition-transform duration-200 group-hover:translate-x-1">
								<HugeiconsIcon icon={ArrowRight02Icon} size={16} strokeWidth={2} />
				...
				<section class="mt-9">
					...
					{#if sent}
						...
						>
							...
							<button
								type="submit"
								class="group mt-6 flex w-full cursor-pointer items-center justify-center gap-2 rounded-mk-control border border-mk-brand bg-mk-brand px-6 py-[15px] font-mk-mono text-[12px] font-medium tracking-[0.12em] text-mk-on-brand uppercase transition-colors duration-200 hover:border-mk-brand-deep hover:bg-mk-brand-deep"
							>
								Open my shop
								<span class="transition-transform duration-200 group-hover:translate-x-1">
									<HugeiconsIcon icon={ArrowRight02Icon} size={16} strokeWidth={2} />
